...
function Contact() {
  return (
    <div className="md:p-16 sm:px-10 px-7 pt-5 PoppinsFont">
      <header>
        <h2 className="md:mb-10 text-sm mb-5 sm:text-base">
          Home / <span className="font-medium"> Contact</span>
        </h2>
      </header>
      <div className="gap-5 lg:flex space-y-5 md:flex-none ">
        <div className="lg:flex lg:flex-col lg:w-[40%] md:w-[100%] md:flex md:gap-10 lg:gap-0 text-sm sm:text-base md:text-sm lg:text-base w-full shadow-2xl md:p-16 sm:p-10 p-5">
          ...
          <div className="PoppinsFont">
            ...
            <div className="space-y-4">
              ...
              <p className="">Email: customer@exclusive.com</p>
              <p className="">Email: support@exclusive.com</p>
            </div>
          </div>
        </div>
        <div className="lg:w-[60%] md:w-[100%] flex justify-center mt-10 md:mt-0">
          <form className=" w-full">
            ...
            <div className="float-right my-5">
              <button
                className="text-white font-medium px-10 py-2 rounded w-full md:w-auto"
